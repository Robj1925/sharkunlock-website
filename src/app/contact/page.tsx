          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 h-fit">
              ...
              <div className="mt-8 pt-8 border-t border-gray-100">
                <a href="/#intake-form" className="w-full inline-flex justify-center items-center px-6 py-3 border border-brand-orange text-base font-bold rounded-md text-brand-orange hover:bg-orange-50 transition-colors">
